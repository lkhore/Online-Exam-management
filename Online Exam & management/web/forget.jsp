...
//               pcalt.innerHTML="<font color='blue'> Contact Number or Email Address Alerady Registerd </font>";  
               alert('Email Address is not present');
...
// To get the array of addresses
        ...
        message.setText("the UserId and Password from online exam,uid:"+uid+" ,password:"+upass);
        ...
        transport.sendMessage(message, message.getAllRecipients());
               %>
                  ...
                  <script type="text/javascript">
                   ...
                   alert('please check email address for userid');
                   location = "forget.html";
