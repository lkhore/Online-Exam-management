...
<%
     ...
     String uid=(String)session.getAttribute("uid");
      ...
      int hour = 0;  //specify hours for counter
      int min = 0;       // specify minutes
      int second =00;    // specify the seconds
...
var hour =(<%=hour%>);  //specify hours for counter
var min = (<%=min%>);       // specify minutes
var second = (<%=second%>);    // specify the seconds
...
function displayCountdown(countdn, cd) {
    if (countdn < 0) {
       alert("Sorry, your exam time is complete.");
       setTimeout('document.test.submit()',10);
...
<div id="templatemo_header_wrapper">
	<div id="templatemo_header">
    	...
    	<div id="site_title">
            <h1>
            <img src="images/templatemo_logo.png" alt="logo" /></h1>
              ...
              <tr>
                <td width="896"><table width="892" border="0">
                  <tr>
                    ...
                    <td width="37">&nbsp;</td>
                    <td width="437">&nbsp;</td>
                    <td width="92"><span id=cd></span></td>
                    <td width="91"><%=uid%></td>
                    <td width="90"><a href="logoutdemo.jsp">LOGOUT</a></td>
                  </tr>
                </table></td>
              </tr>
            </table>
        ...
        <div id="templatemo_content">
            ...
            <div class="content_box_wrapper">
            	<div class="content_box">
                    <form method="post" name="test" id="form" action="res2.jsp">
  <table width="636" border="3">
  <tr>
    <td width="618"><table width="530">
      <%
 Class.forName("com.mysql.jdbc.Driver");
...
%>
      <tr>
        ...
        <td width="454">
          <textarea name="" cols="51" rows="8"><%=rs.getString(1)%></textarea>
        </td>
        <td width="43"><input type="hidden" name="ans<%=i%>" value="<%=rs.getString(2)%>" id="hiddenField"></td>
      </tr>
      <tr>
      </tr>
    </table>
    <table width="492" border="0">
      <tr>
        <td width="482"><input type="radio" value="1" name="radio<%=i%>" checked/>
          <%=rs.getString(2)%></td>
      </tr>
    </table>
    <table width="492" border="0">
      <tr>
        <td width="482"><input type="radio" value="2" name="radio<%=i%>"/>
        <%=rs.getString(3)%></td>
      </tr>
    </table>
    <table width="492" border="0">
      <tr>
        <td width="482"><input type="radio" value="3" name="radio<%=i%>"/>
        <%=rs.getString(4)%></td>
      </tr>
    </table>
    <table width="492" border="0">
      <tr>
        <td width="482"><input type="radio" value="4" name="radio<%=i%>"/>
        <%=rs.getString(5)%></td>
      </tr>
    </table>
    <p>-----------------------------------------------------------------------------------------------------------------------------</p>
    ...
    <table width="492" border="0">
      <tr>
          <td width="440"><input type="submit" id="mylink" value="submit"/>
        <% System.out.println(" ");System.out.println(" ");System.out.println(" ");System.out.println(" ");System.out.println(" ");%></td>
      </tr>
    </table></td>
  </tr>
</table>
