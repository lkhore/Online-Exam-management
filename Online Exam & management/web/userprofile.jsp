...
<div id="templatemo_header_wrapper">
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu">
             <ul>
                <li><a href="admin1.jsp">Home</a></li>   
                
                <li><a href="userprofile.jsp" class="current">Profile Setting</a></li>
            ...
            <div class="content_box_wrapper">
                ...
                <div class="content_box">
                  ...
                  <h4>Profile Setting</h4>
                    <ul class="tmo_list">
                        <li><a href="name.jsp">Name</a></li>
                        <li><a href="password.jsp">Password</a></li>
                        <li><a href="email.jsp">Email</a></li>
                        <li><a href="adrs.jsp">Address</a></li>
                        <li><a href="mobile.jsp">Mobile no.</a></li>
