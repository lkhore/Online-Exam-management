...
<div id="templatemo_middle_wrapper">
	<div id="templatemo_middle">
        ...
        <div id="templatemo_content">
            ...
            <div class="content_box_wrapper">
                ...
                <div class="content_box_wrapper">
                <div class="content_box">
                 <form name="field" onSubmit="return myValidation();" action="namedao.jsp" method="post">
  ...
  <tr>
    ...
    <td><label for="textfield"></label>
      <input  type="text" name="user" id="user"  onblur="charlen(this.id);" maxlength=20 onKeyup="isAlphaNumeric();" size="20" />
