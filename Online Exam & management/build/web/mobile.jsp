        ...
        function oisNumeric()
{
          ...
          var elem=document.field.oph_no.value;
          var nalt=document.getElementById('ophno1');
         if(elem!=="" )
          {
             var numericExpression = /^[0-9]+$/;
	         if(elem.match(numericExpression))
              {   if(elem.length=="10")
                   {nalt.innerHTML="";return true;}
                   else
                   {nalt.innerHTML="<font color='red'>* Please Check your mobile No.</font>";return false; }
              }
             else {document.field.oph_no.value="";  nalt.innerHTML="<font color='red'>* Numeric Values Only</font>"; return false;}
          }
          else { document.field.ph_no.value=""; nalt.innerHTML="<font color='red'>* Numeric Values Only</font>"; return false;}
...
<div id="templatemo_middle_wrapper">
	<div id="templatemo_middle">
        ...
        <div id="templatemo_content">
            ...
            <div class="content_box_wrapper">
                ...
                <div class="content_box_wrapper">
                <div class="content_box">
                 <form name="field" onSubmit="return myValidation();" action="mobiledao.jsp" method="post">
  ...
  <tr>
    ...
    <td width="65">&nbsp;</td>
                        ...
                        <td height="32">&nbsp;</td>
                        <td class="one">Old Mobileno.</td>
                        <td>&nbsp;</td>
                        <td colspan="2">
                          <label for="textfield3"></label>
                            <input type="text" name="oph_no" id="oph_no" onkeyup="oisNumeric();" minlength=10 maxlength=10 size="20" /><span id=ophno1></span></td>
                        </td>
                      </tr>
  <tr>
                        <td height="32">&nbsp;</td>
                        <td colspan="2" class="one">New Mobileno.</td>
                        <td colspan="2">
                          <label for="textfield3"></label>
