...
function myValidation()
{
	...
	var result;
        var result1; 
  result=oemailvalid();
  result1=emailvalid()&&result;
     
  return result1;
}</script>
<script type="text/javascript">

        function oemailvalid()
{
  var emal=document.field.oemail.value;
  var ealt=document.getElementById('oemail1');
  if(emal!=="")
  {
	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu">
             <ul>
                ...
                <li><a href="exam.jsp" >Give Exam</a></li>
...
<div id="templatemo_middle_wrapper">
	<div id="templatemo_middle">
        ...
        <div id="templatemo_content">
            ...
            <div class="content_box_wrapper">
                ...
                <div class="content_box_wrapper">
                <div class="content_box">
                 <form name="field" onSubmit="return myValidation();" action="emaildao.jsp" method="post">
  ...
  <tr>
    ...
    <td width="65">&nbsp;</td>
                        ...
                        <td height="32">&nbsp;</td>
                        <td class="one">Old Email</td>
                        <td>&nbsp;</td>
                        <td colspan="2">
                          <label for="textfield3"></label>
                           <input type="text" name="oemail" id="oemail" onkeyup="oemailvalid();" size="20" /><span id=oemail1></span>
                        </td>
                      </tr>
  <tr>
                        <td height="32">&nbsp;</td>
                        <td colspan="2" class="one">New Email</td>
                        <td colspan="2">
                          <label for="textfield3"></label>
